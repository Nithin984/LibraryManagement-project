...
String message=S.Librarianlog(request.getParameter("user_id"), request.getParameter("password"));
if(message.equalsIgnoreCase("success")) {
	...
	out.println("<!DOCTYPE html>\r\n"
			...
			+ "                </a>\r\n"
			+ "            </header>\r\n"
			+ "<!------------------------             specifiy action attribute here ----------------------------------------->\r\n"
			+ "            <form     method=\"post\"  action=\"./test\">\r\n"
			+ "            <p style=\"text-align: center; color: red; margin-bottom: 15px;\"> "+msg+"                       </p>                  "
